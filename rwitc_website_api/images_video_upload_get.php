...
if ($security->serveCache("images_upload_list")) {
...
try {
    ...
    // Get id, curr_date and path from images_upload
    $sql = "
        SELECT id, curr_date, path, type
        FROM images_upload
        ORDER BY id ASC
    ";
