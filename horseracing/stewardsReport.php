...
include_once('../lib/stewards.class.php');
  ...
  ?>
  <style type="text/css">
  #leftArea.col-lg-9 .contentTable th.thwhite { color: #ffffff !important; background: #04160c !important; }
  #leftArea.col-lg-9 .contentTable th.thwhite h2 { color: #ffffff !important; margin: 0; font-size: 22px; }
  </style>
  <?php
