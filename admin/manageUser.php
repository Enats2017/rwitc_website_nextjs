...
<script type="text/javascript">
    function confirmDelete(adminID) {
        if (confirm ("Are you sure ?")){
            location.href="turf-console/manageUser.php?q=delete-admin&id="+adminID;
        }
    }
</script>
';
...
@media (max-width: 520px) {
    ...
    <?php if ($_SESSION['adminusers'] == "Y") { ?>
        ...
        <div class="admin-header">
            <a class="add-admin-btn" href="turf-console/manageUser.php?q=add-admin"><i class="fas fa-user-plus"></i> Add New Admin</a>
            <!--
            ...
            <div class="rw-modal-overlay" id="rwAdminModal">
              <div class="rw-modal-box">
                <div class="rw-modal-header">
                  ...
                  <a href="turf-console/manageUser.php" class="rw-modal-close" aria-label="Close">&times;</a>
                </div>
                <div class="rw-modal-body">
                  <form action="turf-console/manageUser.php" method="post">
            ...
            <script type="text/javascript">
                ...
                document.addEventListener('keydown', function (e) {
                    if (e.key === 'Escape') { window.location.href = 'turf-console/manageUser.php'; }
                });
                var rwAdminOverlayEl = document.getElementById('rwAdminModal');
                if (rwAdminOverlayEl) {
                    rwAdminOverlayEl.addEventListener('click', function (e) {
                        if (e.target === rwAdminOverlayEl) { window.location.href = 'turf-console/manageUser.php'; }
                    });
                }
            </script>
            <?php } ?>
          ...
          <table class="admin-table">
            ...
            <?php foreach ($allAdmin as $adminDet) { ?>
                <tr>
                    ...
                    <td class="action-col">
                        <a class="edit-link" href="turf-console/manageUser.php?id=<?php echo $adminDet['id'];?>&q=edit-admin"><i class="fas fa-edit"></i> Edit</a>
                        <a class="pass-link" href="turf-console/manageUser.php?id=<?php echo $adminDet['id'];?>&q=change-password"><i class="fas fa-key"></i> Change Password</a>
