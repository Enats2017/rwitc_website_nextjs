        ...
        <table class="table table-bordered">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><a href="admin/email_to_chairman_list.php?type=delete&id=<?php echo $res3['id'];  ?>"><button class="btn btn-danger">Delete</button></a></td>
           
              <td><a href="admin/email_to_chairman_form.php?type1=edit&id=<?php echo $res3['id'];?>"><button class="btn btn-success">Edit</button></a></td>
            </tr>
           <?php }} ?>
          </tbody>
        </table>
