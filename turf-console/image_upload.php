...
if (isAdminlogin()) {
    ...
    if ($_SESSION['bannerManager'] == "Y") { // check login
        ...
        */
                                ...
                                $sql = "INSERT INTO `images_upload` SET `curr_date` = '" . $current_date . "', `enter_date` = '" . $selected_date . "', `path` = '" . $s3_url . "', `type` = '1'";
                        ...
                        $_SESSION['upload_msg'] = 'Images Uploaded Successfully!';
                    ...
                    $_SESSION['upload_msg'] = 'Videos Uploaded Successfully!';
                    header("Location: image_upload.php");
                    exit;
                }
            }
...
<style type="text/css">
    ...
    .iu-form-table input[type="submit"] {
        background: #0f5c33;
        color: #fff;
        border: none;
        padding: 9px 20px;
    ...
    .iu-form-table input[type="submit"]:hover {
        background: #0b3d24;
    }

    .iu-form-table input[type="reset"] {
        background: #fff;
        color: #2b332f;
        border: 1px solid #e2e6e4;
        padding: 9px 20px;
    ...
    .iu-form-table input[type="reset"]:hover {
        background: #f5f4ee;
    }
...
<?php if (isset($_SESSION['upload_msg'])) { ?>
    <div class="message" id="uploadSuccessMsg">
        ...
        <table class="iu-form-table">
            ...
            <tr>
                <td colspan="2">
                    ...
                    <input type="reset" name="reset" value="Clear" onclick="location.href='turf-console/image_upload.php'" />
                </td>
            </tr>
        </table>
    </form>
