...
<script type="text/javascript">
    function delete_feedback(id){ 
        console.log(id);
        $.ajax( {
        url : 'turf-console/email_to_chairman_list.php?type=delete&id='+id,
        type: 'GET',
...
$('#button-filter').on('click', function() {
   ...
   var url = 'turf-console/email_to_chairman_list.php?type=autocomplete';
...
$('input[name=\'filter_name\']').autocomplete({
    'source': function(request, response) {
        $.ajax({
            url: 'turf-console/feedback_query.php?type=filter_name&method=feedback1&filter_name=' + (request.term),
            dataType: 'json',
...
$('input[name=\'filter_email\']').autocomplete({
    'source': function(request, response) {
        $.ajax({
             url: 'turf-console/feedback_query.php?type=filter_email&method=feedback1filter_email=' + (request.term),
            dataType: 'json',
            success: function(json) {
                response($.map(json, function(item) {
                    return {
