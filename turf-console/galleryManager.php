                ...
                try {
                    ...
                    foreach ($files_arr as $fkey => $fvalue) {
                        if ($sponsorID == 1) {
                            ...
                            // ===== S3 Upload (additional, local save untouched) =====
                            $s3_url = '';
                            try {
                                ...
                                $tmpFile = $fvalue['tmp_name'];
                                $s3Key  = 'uploads/Gallery/' . $dirname . '/' . $file;
    ...
    <script type="text/javascript">
        function confirmDelete(imageID,sponsorID) {
            ...
            if (confirm ("Are you sure ?")){
                location.href="turf-console/galleryManager.php?q=delete-image&id="+imageID+"&sponsorID="+sponsorID;
            }
        }
    </script>
  ';
...
<style type="text/css">
    ...
    .gallery-search-row .sponsorList {
        font-size: 13px;
        color: #0f5c33;
        text-decoration: none;
        font-weight: 600;
    ...
    .gallery-search-row .sponsorList:hover {
        text-decoration: underline;
    }

    #search_sponsors_list select {
        border: 1px solid #e2e6e4;
        border-radius: 6px;
        padding: 8px 10px;
        font-size: 14px;
    ...
    .gallery-browse-all summary::-webkit-details-marker {
        display: none;
    }

    .gallery-browse-all summary i {
        transition: transform .2s ease;
    }

    .gallery-browse-all[open] summary i {
        transform: rotate(90deg);
    }

    .gallery-browse-all-panel {
        max-height: 360px;
        overflow-y: auto;
        padding-top: 8px;
    }
    ...
    .image-card .image-actions a.edit-link {
        color: #0f5c33;
    }

    .image-card .image-actions a.delete-link {
        color: #c0392b;
    }
    ...
    .gallery-form-table .sponsorList {
        font-size: 13px;
        color: #0f5c33;
        margin-left: 8px;
    }
    ...
    .gallery-form-table input[type="reset"] {
        background: #0f5c33;
        color: #fff;
        border: none;
        padding: 9px 20px;
...
<?php if ($_SESSION['gallery'] == "Y") { ?>
    ...
    <div class="gallery-header">
        <div class="gallery-header-actions">
            <a class="gallery-btn solid" href="turf-console/galleryManager.php?q=new-image"><i class="fas fa-plus"></i> Add New Image</a>
            <a class="gallery-btn" href="turf-console/galleryManagerbulk.php?q=new-image"><i class="fas fa-layer-group"></i> Add Bulk Image</a>
        </div>
        <!--
        ...
        <div class="rw-modal-overlay" id="rwGalleryModal">
            <div class="rw-modal-box">
                <div class="rw-modal-header">
                    <h3>Add New Image</h3>
                    <a href="turf-console/galleryManager.php" class="rw-modal-close" aria-label="Close">&times;</a>
                </div>
                <div class="rw-modal-body">
                    <form name="dividendForm" method="post" action="turf-console/galleryManager.php" enctype="multipart/form-data">
    ...
    <?php if ($q == "edit-image") { ?>
        <div class="rw-modal-overlay" id="rwGalleryModal">
            <div class="rw-modal-box">
                ...
                <div class="rw-modal-body">
                    <form name="dividendForm" method="post" action="turf-console/galleryManager.php?q=update-image&id=<?php echo $imageDetails['id']; ?>" enctype="multipart/form-data">
                        <table class="gallery-form-table">
                            <col width="32%">
                            <col width="68%">
                            <tr>
    ...
    <?php if ($q == "new-image" || $q == "edit-image") { ?>
        <script type="text/javascript">
            ...
            document.addEventListener('keydown', function(e) {
                if (e.key === 'Escape') {
                    window.location.href = 'turf-console/galleryManager.php';
                }
            });
            ...
            if (rwGalleryOverlayEl) {
                rwGalleryOverlayEl.addEventListener('click', function(e) {
                    if (e.target === rwGalleryOverlayEl) {
                        window.location.href = 'turf-console/galleryManager.php';
                    }
                });
            }
                ...
                <?php if (count($allDates) > 0) { ?>
                    <?php foreach ($allDates as $raceDate) { ?>
                        <div class="date-card">
                            ...
                            <a class="view-link" href="turf-console/galleryManager.php?q=view-images&date=<?php echo $raceDate['racedate']; ?>&sponsorID=<?php echo $raceDate['sponsor_id']; ?>">
                        ...
                        <?php if (count($raceDayImages) > 0) { ?>
                            ...
                            foreach ($raceDayImages as $raceDayImage) {
                                ...
                                echo "<div class='image-actions'>
                                        <a class='edit-link' href='turf-console/galleryManager.php?q=edit-image&id={$raceDayImage['id']}'><i class=\"fas fa-edit\"></i> Edit</a>
        ...
        <script type="text/javascript">
            ...
            if (rwGalleryViewOverlayEl) {
                rwGalleryViewOverlayEl.addEventListener('click', function(e) {
                    if (e.target === rwGalleryViewOverlayEl) {
                        window.location.href = 'turf-console/galleryManager.php';
                    }
                });
            }
