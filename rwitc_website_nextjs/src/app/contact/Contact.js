...
import { FaUser, FaEnvelope, FaCommentDots, FaHorse, FaPhoneAlt, FaMapMarkerAlt, } from "react-icons/fa";
...
export default function Contact() {
    ...
    function renderRecaptcha() {
        ...
        widgetIdRef.current = window.grecaptcha.render(recaptchaRef.current, { sitekey: RECAPTCHA_SITE_KEY, });
            ...
            <section className="contactShell">
                ...
                <div className="contactIntro">
                    ...
                    <p> We'd love to hear from you. <br />
                        Drop us a message and we'll get back <br />
                        to you as soon as possible.
                    </p>

                    <div className="contactInfoList">
                        <div className="contactInfoItem">
                            <span className="contactInfoIcon"> <FaEnvelope /> </span>
                            <div>
                                <strong>Email</strong>
                                <p>info@rwitc.com</p>
                            </div>
                        ...
                        <div className="contactInfoItem">
                            <span className="contactInfoIcon"> <FaPhoneAlt /> </span>
                            <div>
                                <strong>Phone</strong>
                                <p>+91 22 2493 7536</p>
                            </div>
                        ...
                        <div className="contactInfoItem">
                            <span className="contactInfoIcon"> <FaMapMarkerAlt /> </span>
                            <div>
                                <strong>Venue</strong>
                                <p> Royal Western India Turf Club, <br />
                ...
                <div className="contactFormCard">
                    ...
                    >
                        ...
                        <div className="contactField">
                            <label htmlFor="contact-name"> <FaUser className="contactFieldLabelIcon" /> Name </label>
                            <input type="text" id="contact-name" name="name" placeholder="Enter Name" autoComplete="name" required />
                        </div>

                        {/* EMAIL */}
                        <div className="contactField">
                            <label htmlFor="contact-email"> <FaEnvelope className="contactFieldLabelIcon" /> Email </label>
                            <input type="email" id="contact-email" name="email" placeholder="Enter Email" autoComplete="email" required />
                        </div>

                        {/* MESSAGE */}
                        <div className="contactField">
                            <label htmlFor="contact-message"> <FaCommentDots className="contactFieldLabelIcon" /> Message </label>
                            <textarea id="contact-message" name="message" placeholder="Type Your Message" rows="4" required ></textarea>
                        </div>
